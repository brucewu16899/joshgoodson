...
<head>
  ...
  <meta content="Admin Management for JoshGoodson.com" name="description" />
  <meta content="Josh Goodson" name="author" />
...
<body class="page-md page-header-fixed page-quick-sidebar-over-content page-sidebar-closed-hide-logo ">
  ...
  <div class="page-header md-shadow-z-1-i navbar navbar-fixed-top">
    ...
    <div class="page-header-inner">
      ...
      <div class="page-logo">
        <a href="index.html">
          <img src="img/admin/logo.png" alt="logo" class="logo-default" />
        </a>
      ...
      <div class="top-menu">
        <ul class="nav navbar-nav pull-right">
                ...
                <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                  <li>
                    <a href="inbox.html?a=view">
                      <span class="photo">
                  <img src="img/admin/avatar2.jpg" class="img-circle" alt="">
                  </span>
                      <span class="subject">
                  <span class="from">
                  Lisa Wong </span>
                  ...
                  <li>
                    <a href="inbox.html?a=view">
                      <span class="photo">
                  <img src="img/admin/avatar3.jpg" class="img-circle" alt="">
                  </span>
                      <span class="subject">
                  <span class="from">
                  Richard Doe </span>
                  ...
                  <li>
                    <a href="inbox.html?a=view">
                      <span class="photo">
                  <img src="img/admin/avatar1.jpg" class="img-circle" alt="">
                  </span>
                      <span class="subject">
                  <span class="from">
                  Bob Nilson </span>
          ...
          <li class="dropdown dropdown-user">
            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
              <img alt="" class="img-circle" src="img/admin/avatar3_small.jpg" />
        ...
        <ul class="page-sidebar-menu page-sidebar-menu-light" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
          ...
          <li class="start active open">
            ...
            <ul class="sub-menu">
              <li class="active">
                <a href="index.html">
                  <i class="icon-bar-chart"></i> Default Dashboard</a>
              </li>
              <li>
                <a href="index_2.html">
                  <i class="icon-bulb"></i> New Dashboard #1</a>
              </li>
              <li>
                <a href="index_3.html">
                  <i class="icon-graph"></i> New Dashboard #2</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul class="sub-menu">
              <li>
                <a href="form_controls_md.html">
                  <span class="badge badge-roundless badge-danger">new</span>Material Design
                  <br> Form Controls</a>
              </li>
              <li>
                    ...
                    <div class="scroller" style="height: 290px;" data-always-visible="1" data-rail-visible1="1">
                      <div class="row">
                        <div class="col-md-6 user-info">
                          <img alt="" src="img/admin/avatar.png" class="img-responsive" />
                          <div class="details">
                            <div>
                              <a href="javascript:;">
                            Robert Nilson </a>
            ...
            <div class="portlet light ">
              ...
              <div class="portlet-body" id="chats">
                <div class="scroller" style="height: 341px;" data-always-visible="1" data-rail-visible1="1">
                  <ul class="chats">
                    <li class="in">
                      <img class="avatar" alt="" src="img/admin/avatar1.jpg" />
                      <div class="message">
                        <span class="arrow">
                      </span>
                    ...
                    <li class="out">
                      <img class="avatar" alt="" src="img/admin/avatar2.jpg" />
                      <div class="message">
                        <span class="arrow">
                      </span>
                        <a href="javascript:;" class="name">
                    ...
                    <li class="out">
                      <img class="avatar" alt="" src="img/admin/avatar3.jpg" />
                      <div class="message">
                        <span class="arrow">
                      </span>
                        <a href="javascript:;" class="name">
              ...
              <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                ...
                <ul class="media-list list-items">
                  <li class="media">
                    ...
                    <img class="media-object" src="img/admin/avatar3.jpg" alt="...">
                  ...
                  <li class="media">
                    <img class="media-object" src="img/admin/avatar1.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="img/admin/avatar4.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    <img class="media-object" src="img/admin/avatar2.jpg" alt="...">
                    <div class="media-body">
                ...
                <ul class="media-list list-items">
                  <li class="media">
                    ...
                    <img class="media-object" src="img/admin/avatar6.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="img/admin/avatar7.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    <img class="media-object" src="img/admin/avatar8.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="img/admin/avatar9.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    <img class="media-object" src="img/admin/avatar10.jpg" alt="...">
                    <div class="media-body">
                  ...
                  <li class="media">
                    ...
                    <img class="media-object" src="img/admin/avatar11.jpg" alt="...">
                    <div class="media-body">
